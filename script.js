...
// message.innerHTML = `we use cookies for improved functionality and analytics. <button class="btn btn--close-cookie">Got it!</button>1`;
...
// dont use this will remove all classes
...
//   h1.removeEventListenter('mouseenter', alertH1);
// };
